...
if(obj_game.inCombat == 0 && vis)
{
	...
	else
	{
		if(usedTurn == 0)
		{
			DrawUnit(characterID, cindex, index, x + xx, y + yy + ypr + vy - 2, xscale, yscale, c_white, alpha, faction, 6, vy);
		}
		else
		{
			DrawUnit(characterID, cindex, index, x + xx, y + yy + ypr + vy - 2, xscale, yscale, c_white, alpha, faction, 7, vy);
		}
	}
