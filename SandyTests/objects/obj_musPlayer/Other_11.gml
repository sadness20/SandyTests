...
if(ablaze != 0)
{
	...
	audio_sound_gain(global.musInfo[global.currentMusic, 1], 0, 1000);
	audio_sound_gain(global.musInfo[global.currentMusic, 0], 0, 0);
	
	audio_stop_sound(global.musInfo[global.currentMusic, 0]);
	audio_sound_gain(global.musInfo[global.currentMusic, 0], global.optionState[2] / 100, 1000);
